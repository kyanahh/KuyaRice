...
<body>
    ...
    <div class="container my-5 pt-4 mt-5">
        <div class="card shadow-lg p-4 mt-5" style="height:400px;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control me-2" id="searchDetailInput" placeholder="Search" aria-label="Search" oninput="searchDetail()">
                </div>
            </div>
                        ...
                        <table id="menu-table" class="table table-bordered table-hover align-middle mb-0">
                            ...
                            <tbody class="table-group-divider">
                                <?php
                                    ...
                                    FROM order_details INNER JOIN menu 
                                    ON order_details.menuid = menu.menuid 
                                    ORDER BY order_details.orderdetailid DESC");
    ...
    <script>
        //---------------------------Search Order Detail Results---------------------------//
        function searchDetail() {
            const query = document.getElementById("searchDetailInput").value;

            // Make an AJAX request to fetch search results
            $.ajax({
                url: 'search_detail.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
                success: function(data) {
                    // Update the user-table with the search results
                    $('#detail-table tbody').html(data);
                },
        ...
        function deleteDetail(orderdetailid) {
            detailIdToDelete = orderdetailid; // Store the user ID to delete
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (detailIdToDelete) {
                $.ajax({
                    ...
                    method: 'POST',
                    data: { orderdetailid: detailIdToDelete },
                    dataType: 'json',
